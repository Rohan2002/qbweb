                        ...
                        <Accordion.Collapse eventKey="0">
                          <Card.Body>
                            <Summer
                              ...
                              des={
                                "Enriching exercises help students with sentence structure, grammar, and vocabulary. Students explore classic short stories, poems, and novels to strengthen reading comprehension. They also research about prominent American writers."
                              }
                              grade={"4-8"}
                            ></Summer>
                            <Summer
                        ...
                        <Accordion.Collapse eventKey="1">
                          <Card.Body>
                            ...
                            <Summer
                              ...
                              des={
                                "Students will focus on the theory and practical experience in the STEM field, creative writing and public speaking"
                              }
                              grade={"4-8"}
                              border={"none"}
                            ></Summer>
                        ...
                        <Accordion.Collapse eventKey="2">
                          <Card.Body>
                            <Summer
                              name={"Math Preview"}
                              des={
                                "This class will allow school students to “preview” the math class that they will be taking next year: either Geometry, Algebra I/II, Pre-Calculus, or Calculus. They will be introduced to math concepts and will be given a background for accelerated math learning."
                              }
                              grade={"4-12"}
                            ></Summer>
                            <Summer
                        ...
                        <Accordion.Collapse eventKey="4">
                          <Card.Body>
                            ...
                            <Summer
                              ...
                              des={
                                "Students focus ondifferent strategies for writing a coherent and convincing essay. They learn differences in essay styles and develop their own techniques to master both the ACT and SAT essays."
                              }
                              grade={"8-12"}
                              border={"none"}
                            ></Summer>
