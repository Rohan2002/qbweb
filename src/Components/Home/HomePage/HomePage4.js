            ...
            <Grid.Column>
              ...
              <Grid.Row>
                <div className={"news-break"}>
                  <div className={"news-space"}>
                    <Header className={"headline"}>
                      Introduction to Fullstack Web Development(Every Saturday 2-4pm)
                    </Header>
                  </div>
                  <div className={"news-space"}>
                  <Header className={"news-des"}>
              ...
              <Grid.Row>
                <div className={"news-break"}>
                  ...
                  <Header className={"news-des"}>
                    ...
                    <Header className={"news-des"}>
                      Quisque at tellus ullamcorper, pharetra arcu a, suscipit
                      purus. Nullam feugiat in augue in consequat. Sed ac dictum
                      ligula, et pellentesque velit. In gravida eu felis sit
                      amet molestie. Morbi sed ex ac enim finibus vulputate.
                      Cras arcu magna, auctor ornare neque in, finibus tincidunt
                      augue.
                    </Header>
                  </div>
                </div>
